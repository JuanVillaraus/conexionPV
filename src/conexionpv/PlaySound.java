...
public class PlaySound{
    ...
    //Source -> Input
    private static SourceDataLine lineIn;           //fs=50000, sampleSize=8, channels=1, unsigned, bigEndian
    private static AudioFormat formatIn = new AudioFormat(31250, 8, 1, false, true); // format para input
    ...
    public void audio() {
        ...
        try {
            ...
            lineIn.open(formatIn, audioBuf.length); //aquí abre la linea y está listo para reproducir
